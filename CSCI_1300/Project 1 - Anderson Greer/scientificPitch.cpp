...
int main() {
    ...
    // do while loop that runs until the user selects 4 to quit
    do {
        // prompts user with first menu and take input
        ...
        // switch statement that alternates based on user input (1 - 4)
        switch(input) {
            case 1: // user chose option 1
                ...
                // output answer
                cout << "The similarity score is " << bestSimilarity(tune1, target) << endl;
                break;
            case 2: // user chose option 2
                ...
                // output answer
                cout << "The best similarity score is: " << bestSimilarity(tune1, target) << endl;
                break;
    ...
    // user chose option 4 and quit program
    cout << "Goodbye!" << endl;
