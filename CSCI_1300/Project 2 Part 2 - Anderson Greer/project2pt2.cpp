...
int main() {
    ...
    switch(stoi(input)) { // switch statement for user input
        case 1: // user entered 1
        {
            ...
            else if(val == buff.getNumPosts()) { // print if posts was filled before the file was fully read
                cout << "Database is full. Some posts may have not been added." << endl;
                break;
            }
            else if(val >= 0 && val < buff.getNumPosts()) { // prints if posts was not filled by the file
        ...
        case 3: // user entered 3
        {
            ...
            else if(val == buff.getNumUsers()) { // prints if users was filled before the file was fully read
                cout << "Database is full. Some users may have not been added." << endl;
                break;
            }
            else if(val >= 0 && val < buff.getNumUsers()) { // prints if users was not filled up by the file
